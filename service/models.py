...
class FactorySetup(models.Model):
    image = models.ImageField(upload_to='FactorySetup/', blank=True, null=True)
    contant = models.CharField(max_length = 3000)
    contant1 = models.CharField(max_length = 3000, blank=True, null=True)
    contant2 = models.CharField(max_length = 3000, blank=True, null=True)
    contant3 = models.CharField(max_length = 3000, blank=True, null=True)
    pdf_file = models.FileField(upload_to='FactorySetup/pdf', null=True, blank=True)
