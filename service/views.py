import os
from .models import Publication , Category, Company, Requirement, FactorySetup
import fitz  # PyMuPDF
import tempfile
...
def factorySetup(request):
    factorySetup = FactorySetup.objects.all()

    return render(request, 'resource/factorySetup.html', {'factorySetup': factorySetup})
